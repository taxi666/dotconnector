...
sqlp = "select * FROM n where id="&newsId
...
sub produceForm()
	...
	sqlq = "select * from n where id="&Trim(Request.Form("newsId"))
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    ...
    <td>&nbsp;&nbsp;&nbsp;<%=homepage_title%> - <font color="#FF0000">添加/修改通知公告 
      </font>
     <form name="pub_topic" method="post" action="addnews_tz.asp?action=addnew"  ID="pub_topic">
        <table width="98%" border="0" align="center" cellspacing="2" cellpadding="2">
       
          <tr> 
            <td width="13%"> 
              <div align="right">通知公告标题：</div>            </td>
            <td colspan="2"> 
              <input type="text" name="title" size="30" class="button1" value="<%=mtitle%>">            </td>
          </tr>
          <tr> 
            <td valign="top" width="13%"> 
              <div align="right">通知公告内容：</div>            </td>
            <td colspan="2"> <IFRAME STYLE="border: none" NAME=cnEditBox src="EditBox_tz.asp?newsId=<%=newsId%>" WIDTH=500 HEIGHT=400></IFRAME>            </td>
          </tr>
