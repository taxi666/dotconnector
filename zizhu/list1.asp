...
<div id="div_sidebar">
  ...
  exec="select * from n order by id desc"
  ...
  %>
    ...
    %>
      <li class="liclass1">
      <a href="view1.asp?id=<%=rs("id")%>" title="<%=rs("title")%>"  target="_bank"><%=title%></a></li>
	 ...
	 if i>=MaxPerPage then exit do
  	...
  	if pageno<2 then
    		...
    		response.write "<a href='list1.asp?pageno=1'>首页</a>&nbsp;"
    		response.write "<a href='list1.asp?pageno="&(pageno-1)&"'>上一页</a>&nbsp;"
  	end if

  	if n-pageno<1 then
    		response.write "下一页 尾页"
  	else
    		response.write "<a href='list1.asp?pageno="&(pageno+1)&"'>"
    		response.write "下一页</a> <a href='list1.asp?pageno="&n&"'>尾页</a>"
  	end if
