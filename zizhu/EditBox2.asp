...
<%@LANGUAGE="VBSCRIPT"%>
<!--#include file="news/admin/EditBox.inc2.asp"-->
<HTML>
...
<HEAD>
	...
	-->
	<SCRIPT SRC="news/admin/jsinc/rte_res.js"></SCRIPT>
	<SCRIPT SRC="news/admin/jsinc/rte.js"></SCRIPT>		
	<STYLE>
	...
	<STYLE ID=skin DISABLED>
		...
		#tbUpLeft {background:url('news/admin/image/up_left.gif'); }
		#tbUpMiddle {background:url('news/admin/image/up_mid.gif'); }
		#tbUpRight {background:url('news/admin/image/up_right.gif'); }
		#tbMidLeft {background:url('news/admin/image/mid_left.gif'); }
		#tbButtons, #tbContents {background: #FFFFE5;vertical-align: top}
		#tbContents {padding:0px 5px}
		#tbMidRight {background:url('news/admin/image/mid_right.gif'); }
		#tbBottomBar {height:6px}
		#tbLowLeft {background:url('news/admin/image/low_left.gif'); }
		#tbLowMiddle {background:url('news/admin/image/low_mid.gif'); }
		#tbLowRight {background:url('news/admin/image/low_right.gif'); }		
	</STYLE>
	<STYLE ID=appendSkin></STYLE>
